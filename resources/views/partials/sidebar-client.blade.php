<aside class="">
    ...
    <div class="side_content">
        ...
        <ul class="side_menu">
            <li>
                <a href="{{ route('client.dashboard') }}" class="menu_toggle">
                    <figure>
                        <!-- Dashboard Icon -->
            ...
            <li>
                <a href="{{ route('client.projects') }}" class="menu_toggle">
                    <figure>
                        <!-- Dashboard Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2a2a2a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                            <path d="M3 9L12 2L21 9V20A2 2 0 0 1 19 22H5A2 2 0 0 1 3 20V9Z"></path>
            ...
            <li>
                <a href="{{ route('client.documents.index') }}" class="menu_toggle">
                    <figure>
                        <!-- Projects Icon -->
            ...
            <li>
                <a href="{{ route('client.invoices') }}" class="menu_toggle">
                    <figure>
                        <!-- Dashboard Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2a2a2a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                            <path d="M3 9L12 2L21 9V20A2 2 0 0 1 19 22H5A2 2 0 0 1 3 20V9Z"></path>
