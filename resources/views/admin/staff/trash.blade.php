...
<div class="section_header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Trashed Staffs</li>
        </ol>
    </nav>
</div>
    ...
    @forelse($users as $user)
        <tr>
            ...
            <td>
                ...
                <!-- RESTORE -->
                <form method="POST"
                      action="{{ route('admin.staff.restore', $user->id) }}"  style="display:inline">
                    @csrf
                ...
                <!-- PERMANENT DELETE -->
                <form method="POST"
                      action="{{ route('admin.staff.force', $user->id) }}"
