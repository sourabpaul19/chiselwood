...
<div class="section_header">
    <div class="d-flex align-items-center mb-2 justify-content-between">
          <h4>Add Inventory Vendor</h4>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.inventory-vendors.index') }}">Inventory Vendors</a></li>
            <li class="breadcrumb-item active" aria-current="page">Add Inventory Vendor</li>
        </ol>
    </nav>
</div>
...
<form action="{{ route('admin.inventory-vendors.store') }}" method="POST" enctype="multipart/form-data">
@csrf
            ...
            <div class="postbox_body">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <label class="form-label">Inventory Vendor Name</label>
                    ...
                    <div class="col-md-4">
                        <div class="form_group">
                        <label>Inventory Vendor Category</label>
