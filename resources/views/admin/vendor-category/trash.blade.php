...
<div class="section_header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.vendor-category.index') }}">Vendor Categories</a></li>
...
<table class="data_table">
    ...
    <tr>
        ...
        <td class="d-flex gap-2">
            <form method="POST"
                  action="{{ route('admin.vendor-category.restore', $category->id) }}">
                @csrf
                <button class="btn text-success">Restore</button>
            </form>

            <form method="POST"
                  action="{{ route('admin.vendor-category.force', $category->id) }}"
