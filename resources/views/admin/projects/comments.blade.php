...
<div class="section_header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.projects.index') }}">All Projects</a></li>
...
{{-- Add Comment --}}
<form method="POST" action="{{ route('admin.projects.comments.store') }}"  enctype="multipart/form-data">
    @csrf
...
<ul class="comment_list">
    ...
    <li>
        ...
        <div class="comment_body">
            ...
            <div class="image_wrapper">
                ...
                <figure>
                    ...
                    <a href="{{ route('admin.projects.comments.image.delete', $img->id) }}" class="delete_btn">
            ...
            <div class="comment_action">
                ...
                <a href="{{ route('admin.projects.comments.delete', $comment->id) }}" class="text-danger">
                    Delete
                </a>
            </div>
            @endif
        ...
        <div class="reply_body">
            ...
            <li>
                ...
                <div class="comment_body">
                    ...
                    <div class="comment_action">
                        ...
                        <a href="{{ route('admin.projects.comments.delete', $reply->id) }}" class="text-danger">
                            Delete
                        </a>
                    </div>
                    @endif
            ...
            {{-- Reply Form --}}
            <form method="POST" action="{{ route('admin.projects.comments.store') }}" enctype="multipart/form-data" class="mt-2">
                @csrf
                <input type="hidden" name="project_id" value="{{ $project->id }}">
...
@foreach($comments as $comment)
                ...
                <div class="modal fade" id="editCommentModal{{ $reply->id }}" tabindex="-1" aria-labelledby="editCommentLabel{{ $reply->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <form method="POST" action="{{ route('admin.projects.comments.update', $reply->id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="position-relative me-2 mb-2">
                                            ...
                                            <a href="{{ route('admin.projects.comments.image.delete', $img->id) }}" 
        ...
        <div class="modal fade" id="editCommentModal{{ $comment->id }}" tabindex="-1" aria-labelledby="editCommentLabel{{ $comment->id }}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form method="POST" action="{{ route('admin.projects.comments.update', $comment->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-header">
