...
<div class="section_header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Add Service Invoice</li>
        </ol>
    </nav>
</div>
...
<form action="{{ route('admin.service-invoices.store') }}" method="POST">
@csrf

<div class="postbox">
    <div class="postbox_header">
        <h3>Create Service Invoice</h3>
    </div>
    ...
    <div class="postbox_body">
        ...
        <table class="data_table" id="serviceTable">
            ...
            <tbody>
                <tr>
                    <td>
                        <input type="text" name="items[0][name]" class="textbox w-100" required>
                    </td>

                    <td>
                        <input type="number" name="items[0][price]" class="textbox w-100 price" required>
                    </td>

                    <td>
                        <input type="number" name="items[0][gst_rate]" class="textbox w-100 gst" value="18">
                    </td>
        ...
        <div class="row">
            <div class="col-md-4 offset-md-8">
                <table class="table">
                    <tr>
                        <th>Subtotal</th>
                        <td><input id="subtotal" class="textbox w-100" readonly></td>
                    </tr>
                    <tr>
                        <th>CGST</th>
                        <td><input id="cgst_total" class="textbox w-100" readonly></td>
                    </tr>
                    <tr>
                        <th>SGST</th>
                        <td><input id="sgst_total" class="textbox w-100" readonly></td>
                    </tr>
                    <tr>
                        <th>IGST</th>
                        <td><input id="igst_total" class="textbox w-100" readonly></td>
                    </tr>
                    <tr>
                        <th>Discount</th>
                        <td><input name="discount" id="discount" class="textbox w-100" value="0"></td>
                    </tr>
                    <tr>
                        <th>Grand Total</th>
                        <td><input id="grand_total" name="grand_total" class="textbox w-100" readonly></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="text-end">
            <button class="btn btn-theme">Save Invoice</button>
        </div>
