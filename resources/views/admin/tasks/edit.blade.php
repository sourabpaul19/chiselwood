            ...
            <div class="postbox_body">
                    ...
                    {{--<select name="assigned_to" class="textbox w-100">
                        ...
                        @foreach($staffs as $staff)
                            <option value="{{ $staff->id }}"
                                {{ old('assigned_to',$task->assigned_to)==$staff->id?'selected':'' }}>
                                {{ $staff->name }}
                            </option>
                        @endforeach
                    </select>--}}
                ...
                <div class="form_group">
                    ...
                    <textarea name="description" rows="4"
                        class="textbox w-100">{{ old('description', $task->description) }}</textarea>
                        </div>
                </div>
                ...
                @if($task->documents)
                    ...
                    <div class="form_group">
                        ...
                        <ul class="list-group">
                            @foreach($task->documents as $key => $doc)
                                <li class="list-group-item d-flex justify-content-between">
                                    <a href="{{ asset($doc) }}" target="_blank">
                                        {{ basename($doc) }}
                                    </a>
                                    <button type="button"
                                            class="btn text-danger remove-doc"
                                            data-index="{{ $key }}">
                                        Remove
                                    </button>
                                </li>
